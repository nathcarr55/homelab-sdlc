...
Uses Claude via LiteLLM to diagnose test failures and produce targeted fixes.
"""
...
print("Tests failed. Sending to Claude via LiteLLM for diagnosis...")
...
try:
    ...
    print(f"ERROR: LiteLLM API call failed: {e}")
    sys.exit(1)
